...
export const Skills = ({onchange}) => {
  return (
  <>
  <div className='flex justify-end m-2'>  <button onClick={()=>onchange(false)} className='hover:text-pink-500 text-white'><FaTimes size={27}/></button></div>
